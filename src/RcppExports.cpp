...
RcppExport SEXP _formationHeavyr_timesTwo(SEXP xSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _formationHeavyr_invC(SEXP ASEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport void R_init_formationHeavyr(DllInfo *dll) {
